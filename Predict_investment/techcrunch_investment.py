...
#print(onlyfiles)
for f in listdir('/Users/chen/Desktop/VCProjectDL/techcrunch data/'):
    nb_of_file = nb_of_file + 1
    worksheet.write(nb_of_file, 0, f)
    file = open('/Users/chen/Desktop/VCProjectDL/techcrunch data/' + f,"r")
...
np.save('tokens_techcrunch', dictionary)
